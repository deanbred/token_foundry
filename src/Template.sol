...
contract Template is ERC20, Ownable {
    ...
    constructor() ERC20("Template", "Template") {
        ...
        uint256 _buyMarketingTax = 20; // 2%
        uint256 _buyProjectTax = 0;

        uint256 _sellMarketingTax = 20; // 2%
        uint256 _sellProjectTax = 0;

        uint256 _totalSupply = 1_000_000_000 * 10 ** decimals();

        maxTx = (_totalSupply * 20) / 1000; // 2%
        maxWallet = (_totalSupply * 20) / 1000; // 2%

        swapBackValueMin = (_totalSupply * 1) / 1000; // 0.1%
        swapBackValueMax = (_totalSupply * 2) / 100; // 2%
        ...
        marketingWallet = address(0x569B0F8d23b640F9a66520fF1C278476be21D281);
